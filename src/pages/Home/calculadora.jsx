...
export default function Calculadora() {
  ...
  return (
    <div style={{ 
      ...
      <h1 style={{ textAlign: 'center', marginBottom: '30px' }}>Calculadora de Saúde</h1>
      ...
      <div style={{
        ...
        <div style={{ 
          ...
          <h2 style={{ color: '#4CAF50', marginTop: 0 }}>Calculadora de IMC</h2>
          <form onSubmit={calcularIMC}>
            ...
            <label style={{ display: 'block', marginBottom: '15px' }}>
              <span style={{ display: 'block', marginBottom: '5px', fontWeight: 'bold' }}>Altura (m):</span>
              <input 
                type="number" 
                name="altura" 
                step="0.01" 
        ...
        <div style={{ 
          ...
          <h2 style={{ color: '#2196F3', marginTop: 0 }}>Necessidade de Proteína</h2>
          <form onSubmit={calcularProteina}>
            ...
            <label style={{ display: 'block', marginBottom: '15px' }}>
              <span style={{ display: 'block', marginBottom: '5px', fontWeight: 'bold' }}>Objetivo:</span>
              <select 
                value={objetivo}
          ...
          {proteinaDiaria && (
            <div style={{ 
              ...
              <p style={{ fontSize: '24px', fontWeight: 'bold', margin: '10px 0' }}>
                {proteinaDiaria}g <span style={{ fontSize: '16px' }}>de proteína/dia</span>
              </p>
            </div>
          )}
        </div>
